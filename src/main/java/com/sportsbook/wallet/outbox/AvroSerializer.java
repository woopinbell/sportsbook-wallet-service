...
/**
 * Binary-encodes Avro records for the outbox payload column. V1 publishes without a Schema Registry
 * (ADR-0014); each consumer pins the same shared-protocol generated classes so the schema id is
 * implicit. This helper exists so the encode boilerplate does not leak into the service layer.
 */
